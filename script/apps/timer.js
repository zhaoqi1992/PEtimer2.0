$('document').ready(function() {
	...
	$('#start').click(function(e) {
		...
		if (clicknumber_pause % 2) {
			...
			timerInterval = setInterval(timer, 5);
	...
	$('#show').click(function(e) {
		...
		if ($('#grade td')) {
			...
			var gradeForStudent = '<div class="center-block col-xs-8 timePanel text-danger">' + time.eq(listNumber).text() + '</div>';
			$('.timePanel').replaceWith(gradeForStudent);
